...
interface AuthContextType {
  ...
  hasAccess: (page: 'analyzer' | 'users') => boolean;
}
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const hasAccess = (page: 'analyzer' | 'users'): boolean => {
    ...
    switch (user.role) {
      ...
      case 'specialist':
        return page === 'analyzer'; // Только к анализатору
      case 'manager':
        return page === 'users'; // Только к справочнику пользователей
      default:
        return false;
    }
  };

      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-red-500 pl-4">
            <h3 className="font-semibold text-gray-800">Как экспортировать данные?</h3>
            <p className="text-sm text-gray-600 mt-1">
              Используйте таблицу результатов для копирования данных. Графики можно сохранить как изображения через контекстное меню браузера.
            </p>
          </div>
        </div>
      </div>

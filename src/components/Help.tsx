  ...
  return (
    <div className="space-y-6">
              ...
              <div className="text-xs text-blue-800 space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  <div>
                    ...
                    <p>• <code>{'{SerialNumber}'}</code> - серийный номер объекта квалификации</p>
                    <p>• <code>{'{InventoryNumber}'}</code> - инвентарный номер объекта квалификации</p>
                  </div>
                  <div>
                ...
                <div className="mt-3 p-2 bg-blue-100 rounded space-y-1">
                  ...
                  <p className="text-xs"><strong>Плейсхолдеры данных:</strong> <code>{'{Position}'}</code> подставляется из справочника пользователей (поле «Должность» текущего пользователя). <code>{'{Size}'}</code> — только значение площади объекта квалификации. <code>{'{SerialNumber}'}</code> и <code>{'{InventoryNumber}'}</code> — серийный и инвентарный номер объекта квалификации из карточки объекта.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Основные: {'{chart}'} (изображение), {'{Table}'} (таблица), {'{Result}'} (выводы), {'{Object}'} (наименование объекта квалификации), {'{NameTest}'} (тип испытания), {'{Position}'} (должность), {'{Size}'} (площадь объекта), {'{SerialNumber}'} (серийный номер объекта квалификации), {'{InventoryNumber}'} (инвентарный номер объекта квалификации). Дополнительные: {'{Limits}'} (лимиты), {'{Executor}'} (исполнитель), {'{TestDate}'} (дата), {'{ReportNo}'} (номер договора), {'{ReportDate}'} (дата договора).
        </p>
          </div>
        </div>
      </div>

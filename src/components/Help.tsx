      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mb-8">
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-purple-900 mb-4">📄 Создание шаблонов отчетов</h3>
            
            <div className="space-y-4 text-sm text-purple-800">
              <div>
                <h4 className="font-medium mb-2">Поддерживаемые плейсхолдеры:</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h5 className="font-medium text-purple-900">Основная информация:</h5>
                    <ul className="list-disc list-inside space-y-1 text-xs">
                      <li><code>{'{Report No.'}</code> - Номер отчета</li>
                      <li><code>{'{Report date}'}</code> - Дата отчета</li>
                      <li><code>{'{name of the object}'}</code> - Название объекта</li>
                      <li><code>{'{name of the air conditioning system}'}</code> - Климатическая установка</li>
                      <li><code>{'{name of the test}'}</code> - Вид испытания</li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="font-medium text-purple-900">Временные данные:</h5>
                    <ul className="list-disc list-inside space-y-1 text-xs">
                      <li><code>{'{Date time of test start}'}</code> - Дата и время начала</li>
                      <li><code>{'{Date time of test completion}'}</code> - Дата и время завершения</li>
                      <li><code>{'{Duration of the test}'}</code> - Длительность испытания</li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="font-medium text-purple-900">Результаты:</h5>
                    <ul className="list-disc list-inside space-y-1 text-xs">
                      <li><code>{'{acceptance criteria}'}</code> - Критерии приемки</li>
                      <li><code>{'{Results table}'}</code> - Таблица результатов</li>
                      <li><code>{'{Result}'}</code> - Выводы и заключение</li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="font-medium text-purple-900">Исполнители и график:</h5>
                    <ul className="list-disc list-inside space-y-1 text-xs">
                      <li><code>{'{executor}'}</code> - Исполнитель</li>
                      <li><code>{'{director}'}</code> - Руководитель</li>
                      <li><code>{'{test date}'}</code> - Дата проведения</li>
                      <li><code>{'{chart}'}</code> - График (повернутый на 90°)</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-purple-100 p-3 rounded">
                <p className="text-xs">
                  <strong>Инструкция:</strong> Создайте DOCX документ в Microsoft Word, вставьте плейсхолдеры в нужные места. 
                  Плейсхолдер <code>{'{Results table}'}</code> будет заменен на таблицу с результатами анализа, 
                  а <code>{'{chart}'}</code> - на изображение графика, повернутое на 90° против часовой стрелки.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• Используйте данные из таблицы результатов для создания отчетов</li>
                <li>• Экспортируйте графики как изображения</li>
                <li>• Создавайте отчеты в внешних программах (Word, Excel)</li>
                <li>• Копируйте статистические данные из таблицы</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-green-500 pl-4">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Используйте данные из таблицы результатов для создания отчетов в Microsoft Word или других программах. Копируйте статистические данные и экспортируйте графики.
            </p>
          </div>
          ...
          <div className="border-l-4 border-red-500 pl-4">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Создайте DOCX шаблон с плейсхолдерами, загрузите его в раздел "Генерация отчета", заполните форму и нажмите "Сгенерировать отчет". Система автоматически заменит плейсхолдеры на актуальные данные и вставит график с таблицей результатов.
            </p>
          </div>
        </div>
      </div>

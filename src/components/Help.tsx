        ...
        <div className="mb-8">
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
            ...
            <div className="space-y-4 text-sm text-purple-800">
              <div>
                <h4 className="font-medium mb-2">Как создать шаблон:</h4>
                <ol className="list-decimal list-inside space-y-1 ml-4">
                  <li>Создайте документ Word (.docx)</li>
                  <li>Вставьте плейсхолдеры из списка ниже в нужные места</li>
                  <li>Сохраните документ и загрузите в систему</li>
                  <li>Заполните данные и сгенерируйте отчет</li>
                </ol>
              </div>
              
              <div>
                <h4 className="font-medium mb-2">Доступные плейсхолдеры:</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      ...
                      <li>{`{name of the test}`} - Вид испытания</li>
                    </ul>
                  </div>
                  <div>
                    <strong>Временные данные:</strong>
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      <li>{`{Date time of test start}`} - Дата и время начала</li>
                      <li>{`{Date time of test completion}`} - Дата и время завершения</li>
                      <li>{`{Duration of the test}`} - Длительность испытания</li>
                    </ul>
                  </div>
                  <div>
                  ...
                  <div>
                    <strong>Исполнители и график:</strong>
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      <li>{`{executor}`} - Исполнитель</li>
                      <li>{`{director}`} - Руководитель</li>
                      <li>{`{test date}`} - Дата проведения</li>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="border-l-4 border-red-500 pl-4">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Создайте шаблон Word с плейсхолдерами, загрузите его в раздел "Генерация отчета", заполните необходимые поля и нажмите "Сгенерировать отчет". График автоматически повернется на 90° против часовой стрелки.
            </p>
          </div>
        </div>
      </div>

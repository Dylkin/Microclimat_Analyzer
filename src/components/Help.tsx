          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
            ...
            <div className="space-y-4 text-sm text-purple-800">
              <div>
                ...
                <ol className="space-y-1 list-decimal list-inside ml-4">
                  ...
                  <li>Вставьте плейсхолдеры в нужные места (например: {'{Report No.}'} для номера отчета)</li>
                  <li>Для таблицы результатов используйте плейсхолдер {'{Results table}'}</li>
                  <li>Для графика используйте плейсхолдер {'{chart}'} - изображение будет автоматически повернуто на 90° против часовой стрелки</li>
                  <li>Сохраните документ и загрузите как шаблон в разделе "Генерация отчета"</li>
                </ol>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="mt-1 space-y-1 text-xs">
                      <li>• {`{reportNo} - Номер отчета`}</li>
                      <li>• {`{reportDate} - Дата отчета`}</li>
                      <li>• {`{nameOfObject} - Название объекта`}</li>
                      <li>• {`{nameOfAirConditioningSystem} - Климатическая установка`}</li>
                    </ul>
                  </div>
                  <div>
                    <strong>Результаты:</strong>
                    <ul className="mt-1 space-y-1 text-xs">
                      <li>• {`{resultsTable} - Таблица результатов`}</li>
                      <li>• {`{chart} - График (повернутый на 90°)`}</li>
                      <li>• {`{result} - Выводы и заключение`}</li>
                      <li>• {`{acceptanceCriteria} - Критерии приемки`}</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-4 p-3 bg-purple-100 rounded-lg">
              <p className="text-xs text-purple-700">
                <strong>Важно:</strong> График автоматически поворачивается на 90° против часовой стрелки для удобства размещения в отчете. 
                Таблица результатов автоматически заполняется данными из анализа.
              </p>
            </div>
          </div>
        </div>

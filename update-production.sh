...
# Применяем миграции БД (всегда проверяем и применяем недостающие)
echo "🗄️  Применение миграций базы данных..."
sudo -u "$PROJECT_USER" npm run migrate || echo "⚠️  Предупреждение: Ошибка при применении миграций"

...
CREATE TABLE IF NOT EXISTS public.projects (
  ...
  contract_date DATE,
  total_cost_with_vat NUMERIC(15, 2),
...
CREATE TABLE IF NOT EXISTS public.qualification_objects (
  ...
  object_type TEXT NOT NULL CHECK (object_type IN ('cold_chamber', 'freezer', 'refrigerator', 'thermo_container', 'vehicle', 'room')),
  climate_system TEXT,
  ...
  plan_file_url TEXT,
  plan_file_name TEXT,
  equipment_placement_plan_file_url TEXT,
  equipment_placement_plan_file_name TEXT,
  equipment_placement_saved_at TIMESTAMP WITH TIME ZONE,
  equipment_placement_saved_by TEXT,
...
/*
Политики RLS и правила для storage при необходимости настраиваются отдельно.
Используйте собственные механизмы аутентификации и добавьте политики вручную.
*/
